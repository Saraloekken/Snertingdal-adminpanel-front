 ...
 */      
    ...
    remove(id, event) {
        ...
        var form = new FormData();
        form.append('events', JSON.stringify({id: id}));

        fetch('http://folk.ntnu.no/saralok/snertingdal/pages/events/events-delete.php', {
            method: 'POST',
            body: form,
        })
            .then(() => {
            ...
            <div className="everything">
                ...
                <div className="placeholder">
                    ...
                    <div className="history-info">
                        <textarea name='short_description' placeholder="Kort om eventet"
                                  value={this.state.short_description} onChange={this.handleChange.bind(this)}/>
                    </div>
                    ...
                    <div className="text-input">
                        <input type="date" name='dateday' className="friendsinput" placeholder="11/11/11"
                               value={this.state.dateday} onChange={this.handleChange.bind(this)}/>
                    </div>

                    <h6>Tid for eventet (fra-til):</h6>
                    <div className="text-input">
                        <input type="time" name='from_time' className="friendsinput" placeholder="17:00"
                               value={this.state.from_time} onChange={this.handleChange.bind(this)}/>
                        <input type="time" name='to_time' className="friendsinput" placeholder="17:00"
                               value={this.state.to_date} onChange={this.handleChange.bind(this)}/>
                    </div>
                    ...
                    <div className="history-info">
                        <textarea name='long_description' placeholder="Hva vil du fortelle om eventet ditt?"
                                  value={this.state.long_description} onChange={this.handleChange.bind(this)}/>
                    </div>

                    <h6>Hvem holder eventet:</h6>
                    <div className="text-input">
                        <input type="text" name='holder_name' className="friendsinput"
                               placeholder="Hvem skal holde eventet?" value={this.state.holder_name}
                               onChange={this.handleChange.bind(this)}/>
                    </div>
                    <h6>Om den som holder eventet:</h6>
                    <div className="history-info">
                        <textarea name='holder_info' placeholder="Hva vil du fortelle om eventholder?"
                                  value={this.state.holder_info} onChange={this.handleChange.bind(this)}/>
                    </div>

                    <h6>Link til billettsalg:</h6>
                    <div className="text-input">
                        <input type="text" name='link' className="friendsinput" placeholder="<link til billettssalg>"
                               value={this.state.link} onChange={this.handleChange.bind(this)}/>
                    </div>
                    ...
                    {this.state.events.map(item => (
                        <div key={item.id} className="element">
                            ...
                            <div className="element-left">
                                ...
                                <p className="undertittel">Kl.<Moment date={item.dateday + ' ' + item.from_time}
                                                                      format='HH:mm'/></p>

                            </div>

                            <div className="element-right">
                                <div className="delete" onClick={this.remove.bind(this, item.id)}><i
                                    className="fal fa-trash-alt"/></div>
                            </div>
                        </div>
                    ))}
                </div>
