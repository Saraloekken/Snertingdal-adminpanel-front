...
getData(){
    ...
    render()   {
        return ( 
            ...
            <select className="select" name='link' value={this.state.link} onChange={this.handleChange.bind(this)}>
                ...
                <h6>Overskrift:</h6>
                <div className="text-input">
                    <input type="text" name='headline' className="friendsinput"  placeholder="Overskrift" value={this.state.headline} onChange={this.handleChange.bind(this)}/>            
                </div>

                <h6>Undertittel</h6>
                <div className="text-input">
                    <input type="text" name='subtitle' className="friendsinput" placeholder="Undertittel" value={this.state.subtitle} onChange={this.handleChange.bind(this)}/>            
                </div>
